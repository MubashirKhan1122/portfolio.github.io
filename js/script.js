  ...
  connectedCallback() {
    this.innerHTML = `
        ...
        <div class="container-fluid">
          <div class="footer">
            <div class="sort-note">
              <a class="navbar-brand" href="index.html">Mubashir Khan</a>
              <p>I’m Mubashir Khan, a junior and talented Web Designer with front end development skills.</p>
            ...
            <div class="social-links text-center">
              <a href="https://www.linkedin.com/in/mubashir-khan-50028a318/"><img src="./img/LinkedIn Circled.png" alt="linkedin"></a><br>
